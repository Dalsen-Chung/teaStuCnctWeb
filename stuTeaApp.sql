...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='管理员基础信息表';
...
-- 正在导出表  teastucnct.major_info_tb 的数据：~0 rows (大约)
...
-- 正在导出表  teastucnct.stu_user_tb 的数据：~0 rows (大约)
